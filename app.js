(() => {
  ...
  const state = {level:0,unlocked:Math.min(6,Math.max(1,saved)),round:1,score:0,streak:0,correctInLevel:0,colors:[],selection:[],answerType:"light",locked:false,gray:false,sceneName:"",mastery:Array.from({length:6},(_,i)=>Number(storedMastery[i])||0)};
